...
y1 = zeros(nt,1);
TCd{1} = {A1,G1,b1,C1,f1,y1};   % concrete & insulation
...
f4 = 1;
y4 = 1;
TCd{4} = {A4,G4,b4,C4,f4,y4};   % infiltration & controller
...
disp('Local and global indexes of nodes');      disp(Idx{1})
disp('Local and global indexes of branches');   disp(Idx{2})
...
u = [Temp Temp Temp TintSP ...
  epswSW*Sc*PhiTot taugSW*epswSW*Sg*PhiTot alphagSW*Sg*PhiTot Qa]';
